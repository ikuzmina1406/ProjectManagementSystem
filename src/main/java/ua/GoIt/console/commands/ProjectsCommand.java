...
public class ProjectsCommand implements Command {
    ...
    private void delete(String params) { //projects delete id (the command: "projects delete 27")
        String [] paramsArray = params.split(" ");
    ...
    private void get(String params) { // project get id
        String [] paramsArray = params.split(" ");
        Optional<Projects> projects =  projectsDao.get(Long.parseLong(paramsArray[0]));
        if (projects.isPresent()){
    ...
    private void update(String params) {// projects update ID NAME INFO STATUS COST (the command: "projects update 27 ConCurrancy change 1 50000.00  ")
        String [] paramsArray = params.split(" ");
    ...
    private void create(String params) { //projects create (the command : projects create NAME INFO STATUS COST (" projects create Currancy change 1 50000.00 "))
        String [] paramsArray = params.split(" ");
